...
export { HwEditorCorners } from './editor-corners.interface.js';
export { HwEditorDoor } from './editor-door.interface.js';
...
export { HwEditorSecondary } from './editor-secondary.interface.js';
