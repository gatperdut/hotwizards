  ...
  private charactersToHeroes(
    ...
    return memberships.map((membership, index) => {
      ...
      return {
        ...
        me: false,
        alignment: 'HERO',
        bodyPoints: creatureMaxBodyPoints(character.klass, character.inventory),
        mindPoints: creatureMaxMindPoints(character.klass, character.inventory),
        ...
        actionPoints: creatureMaxActionPoints(character.klass, character.inventory),
    ...
    return cells
      .map((cell) => {
        ...
        const monster: HwMonster = {
          ...
          alignment: 'MONSTER',
          bodyPoints: creatureMaxBodyPoints(cell.monster.type, inventory),
          mindPoints: creatureMaxMindPoints(cell.monster.type, inventory),
          attackDie: creatureAttackDie(cell.monster.type, inventory),
          defendDie: creatureDefendDie(cell.monster.type, inventory),
          actionPoints: creatureMaxActionPoints(cell.monster.type, inventory),
          movementPoints: movementPoints,
          maxMovementPoints: movementPoints,
