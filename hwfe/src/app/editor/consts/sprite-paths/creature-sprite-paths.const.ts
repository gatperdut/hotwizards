...
export const CreatureSpriteOffsets: Record<CreatureSpritePath, SpriteOffset> = {
  ...
  '/tiles/monsters/goblin_axe_n.png': { x: 2, y: -63 },
  '/tiles/monsters/goblin_axe_e.png': { x: -1, y: -63 },
  '/tiles/monsters/goblin_axe_s.png': { x: -1, y: -63 },
  '/tiles/monsters/goblin_axe_w.png': { x: -1, y: -63 },
  '/tiles/monsters/goblin_dagger_n.png': { x: -1, y: -33 },
  '/tiles/monsters/goblin_dagger_e.png': { x: -3, y: -33 },
  '/tiles/monsters/goblin_dagger_s.png': { x: -1, y: -33 },
  '/tiles/monsters/goblin_dagger_w.png': { x: 3, y: -30 },
  '/tiles/monsters/goblin_sword_n.png': { x: 3, y: -30 },
  '/tiles/monsters/goblin_sword_e.png': { x: 3, y: -30 },
  '/tiles/monsters/goblin_sword_s.png': { x: 3, y: -30 },
  '/tiles/monsters/goblin_sword_w.png': { x: 3, y: -30 },
} as const;
